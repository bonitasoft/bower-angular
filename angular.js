/**
 * @license AngularJS v1.3.21-local+sha.02b1c01
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.21-local+sha.02b1c01/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.21-local+sha.02b1c01',    // all of these placeholder strings will be replaced by grunt's
